...
<li>
<ul class="float-left">
<li><a href="#" class="color-c<?= $character['Character']['class'] ?>"><?php echo $character['Character']['name'] ?></a></li>
</ul>
...
<?= $this->Html->link('Ajouter un personnage', array('action' => 'create'), array('class' => 'ui-button')) ?>
</div>
