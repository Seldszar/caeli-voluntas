...
<div class="zone-name"><?= $zone['EncounterZone']['name'] ?></div>
<div class="zone-progress" title="<?= htmlspecialchars($this->requestAction(array('controller' => 'encounterZones', 'action' => 'tooltip', $zone['EncounterZone']['id']), array('return'))) ?>">
