...
<?= $this->Html->link('Editer', array('action' => 'edit', $zone['EncounterZone']['id']), array('class' => 'ui-button')) ?>
<?= $this->Html->link('Supprimer', array('action' => 'delete', $zone['EncounterZone']['id']), null, 'Voulez-vous vraiment supprimer cette zone ?') ?>
</div>
<?php $this->end() ?>
...
<div class="section-action">
<?= $this->Html->link('Ajouter un boss', array('controller' => 'encounters', 'action' => 'create', $zone['EncounterZone']['id']), array('class' => 'ui-button')) ?>
</div>
