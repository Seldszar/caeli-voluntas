...
<p style="font-size: 18px; margin: 0 0 10px 0; margin-bottom: 10px; text-align: center"><a style="color: #96A3BB; text-decoration: none" href="<?php echo $this->Html->url(array('action' => 'resetPassword', $salt), true) ?>">Réinitialiser mon mot de passe</a></p>
