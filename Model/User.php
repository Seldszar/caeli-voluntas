...
class User extends AppModel {
	...
	public function __construct($id = false, $table = null, $ds = null) {
		...
		$this->virtualFields['avatar_url'] = sprintf("CONCAT('http://www.gravatar.com/avatar/', COALESCE(%s.gravatar_hash, MD5(LOWER(%s.email))), '?d=identicon')", $this->alias, $this->alias);
	}
